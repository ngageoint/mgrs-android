...
Pull from the [Maven Central Repository](http://search.maven.org/#artifactdetails|mil.nga.mgrs|mgrs-android|1.0.1|aar) (AAR, POM, Source, Javadoc)

    api 'mil.nga.mgrs:mgrs-android:1.0.1'
