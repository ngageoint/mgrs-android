...
Pull from the [Maven Central Repository](http://search.maven.org/#artifactdetails|mil.nga.mgrs|mgrs-android|2.0.0|aar) (AAR, POM, Source, Javadoc)

    api 'mil.nga.mgrs:mgrs-android:2.0.0'
